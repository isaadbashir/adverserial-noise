...
3. **Implement your changes**: Add new attacks, improve existing ones, or enhance utilities
...
1. Inherit from `AdversarialAttackBase`
2. Implement the `_perturb` method
...
2. Add framework-specific tensor operations
...
```bash
pytest --cov=adverserial_noise tests/
```
...
```bibtex
@software{adverserial_noise,
  title={Adversarial Noise: A Framework-Agnostic Library for Adversarial Attacks},
  author={Saad Bashir},
  year={2024},
  url={https://github.com/isaadbashir/adverserial-noise}
}
```
...
- **Documentation**: Check the examples and docstrings for detailed usage

## Roadmap

- [ ] Additional attack methods (PGD, C&W, DeepFool)
- [ ] TensorFlow backend support
- [ ] JAX backend support
- [ ] Attack evaluation metrics
- [ ] Defensive training utilities
